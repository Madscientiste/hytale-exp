...
/**
 * Stateful service for loading and saving RCON configuration from/to disk. Uses
 * a dedicated config
 * file at configs/com.madscientiste.rcon.json instead of storing in
 * config.json.
 */
public class ConfigLoader {
    ...
    /**
     * Update password hash in config file. Loads current config, updates password
     * hash, and saves.
     *
     ...
     * @return RconConfig instance with values from map, using defaults for missing
     *         values
     */
    @Nonnull
    ...
    /**
     * Simple JSON object parser for key-value pairs. Handles: "key": "value" and
     * "key": number.
     */
    @Nonnull
