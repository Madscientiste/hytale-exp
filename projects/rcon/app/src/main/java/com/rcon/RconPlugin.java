...
/**
 * Hytale plugin wrapper for RCON server.
 * Integrates RconServer into the Hytale plugin lifecycle.
...
public class RconPlugin extends JavaPlugin {
    ...
    /**
     * Get the RCON server instance.
     * Useful for accessing server stats or configuration.
     *
