...
/**
 * Command dispatcher - routes command strings to appropriate Command
 * implementations.
 * Phase 2: Integrates with Hytale server commands.
 */
public class CommandDispatcher {
    ...
    /**
     * Get the default command (HytaleCommand), creating it lazily if needed.
     * This avoids loading Hytale classes during construction, which allows
     * tests to run without HytaleServer.jar in the classpath.
     */
