...
/**
 * Utility class to convert Hytale Message objects to plain text strings.
 * Strips ANSI color codes for RCON protocol compatibility.
 */
public class MessageConverter {
     ...
     * Removes color codes, formatting codes, and other ANSI sequences.
     * 
