...
/**
 * CommandSender implementation for RCON command execution.
 * Captures all messages sent during command execution for RCON response.
 * Grants all permissions (like console).
 */
