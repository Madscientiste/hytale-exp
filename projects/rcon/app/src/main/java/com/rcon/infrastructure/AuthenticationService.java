...
/**
 * Handles password hashing and validation for RCON authentication.
 * Uses SHA-256 with salt for password storage (simple but sufficient for internal use).
 * For production, consider bcrypt/Argon2, but SHA-256 is acceptable for internal tools.
 */
public class AuthenticationService {
     ...
     * Usage: java AuthenticationService <password>
     */
