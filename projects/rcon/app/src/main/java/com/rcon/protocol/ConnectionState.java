...
/**
 * Connection state machine for RCON protocol. Simple and explicit state transitions as requested.
 */
  ...
  private TransitionResult handleAuthenticatedState(RconPacket packet) {
    if (packet.getType() == RconPacket.SERVERDATA_EXECCOMMAND) {
      ...
      return TransitionResult.failure(
          "Invalid packet type for authenticated state: " + packet.getType());
    }
  }
