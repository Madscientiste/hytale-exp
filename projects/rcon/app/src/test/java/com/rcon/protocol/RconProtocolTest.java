...
/**
 * Tests for RconProtocol parsing and validation.
 * Critical for security - tests edge cases and malformed input.
 */
public class RconProtocolTest {
    ...
    public void testOversizedFrame() {
        ...
        assertTrue("Error message should mention size", 
                   result.getErrorMessage().contains("too large"));
    }
    ...
    public void testIncompletePacket() {
        ...
        assertTrue("Should be ProtocolError", result instanceof RconProtocol.ProtocolError);
        assertTrue("Error message should mention incomplete", 
                   result.getErrorMessage().contains("Incomplete"));
    }
    ...
    public void testMalformedPacket() {
        ...
        assertTrue("Should be either success or error", 
